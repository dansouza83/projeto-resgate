...
$wp_customize->add_setting('queroestudar_url', array(
 'default'              => _x('https://projetoresgate.org.br/quero-estudar-projeto-resgate/', 'cleancut'),
 'type'                 => 'theme_mod'
));
...
$wp_customize->add_setting('querocolaborar_url', array(
 'default'   => _x('https://projetoresgate.org.br/quero-colaborar-projeto-social-joinville/', 'cleancut'),
 'type'      => 'theme_mod'
));
 ...
 */
 ...
 $wp_customize->add_setting('number_1_icon', array(
  'default'    => _x('fa fa-4x fa-star', 'cleancut'),
  'type'      => 'theme_mod'
 ));
 ...
 $wp_customize->add_setting('number_2_icon', array(
  'default'    => _x('fa fa-4x fa-graduation-cap', 'cleancut'),
  'type'      => 'theme_mod'
 ));
 ...
 $wp_customize->add_setting('number_3_icon', array(
  'default'    => _x('fa fa-4x fa-book', 'cleancut'),
  'type'      => 'theme_mod'
 ));
 ...
 $wp_customize->add_setting('number_4_icon', array(
  'default'    => _x('fa fa-4x fa-heart', 'cleancut'),
  'type'      => 'theme_mod'
 ));
 ...
 */
 ...
 $wp_customize->add_setting('white_section_1_icon', array(
  'default'    => _x('fa fa-4x fa-user', 'cleancut'),
  'type'      => 'theme_mod'
 ));
 ...
 $wp_customize->add_setting('white_section_2_icon', array(
  'default'    => _x('fa fa-4x fa-certificate', 'cleancut'),
  'type'      => 'theme_mod'
 ));
 ...
 $wp_customize->add_setting('white_section_3_icon', array(
  'default'    => _x('fa fa-4x fa-universal-access', 'cleancut'),
  'type'      => 'theme_mod'
 ));
 ...
 */
 ...
 //  'title'       => __('', 'cleancut'),
 //  'description' => sprintf(__('Options for ', 'cleancut')),
 //  'priority'    => 180
 // ));
